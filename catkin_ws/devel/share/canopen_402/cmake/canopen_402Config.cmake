...
if("TRUE" STREQUAL "TRUE")
  set(canopen_402_SOURCE_PREFIX /home/alessandro/WheelchairControl/catkin_ws/src/ros_canopen/canopen_402)
  set(canopen_402_DEVEL_PREFIX /home/alessandro/WheelchairControl/catkin_ws/devel)
  ...
  set(canopen_402_INSTALL_PREFIX /home/alessandro/WheelchairControl/catkin_ws/install)
...
if(NOT "/home/alessandro/WheelchairControl/catkin_ws/src/ros_canopen/canopen_402/include;/usr/include " STREQUAL " ")
  set(canopen_402_INCLUDE_DIRS "")
  set(_include_dirs "/home/alessandro/WheelchairControl/catkin_ws/src/ros_canopen/canopen_402/include;/usr/include")
  ...
  elseif(NOT "http://wiki.ros.org/canopen_402 " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/canopen_402' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'canopen_402' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'canopen_402' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alessandro/WheelchairControl/catkin_ws/src/ros_canopen/canopen_402/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT canopen_402_NUM_DUMMY_TARGETS)
      set(canopen_402_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::canopen_402::wrapped-linker-option${canopen_402_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR canopen_402_NUM_DUMMY_TARGETS "${canopen_402_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::canopen_402::wrapped-linker-option${canopen_402_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND canopen_402_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(canopen_402_EXPORTED_TARGETS ${${canopen_402_dep}_EXPORTED_TARGETS})
endforeach()
