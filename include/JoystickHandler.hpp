...
private:
    ...
    // Static maps for axis and button names
...
inline const std::map<int, std::string> JoystickHandler::AXIS_NAMES = {
    {0x00, "x"},
    {0x01, "y"},
    {0x02, "z"},
    {0x03, "rx"},
...
inline const std::map<int, std::string> JoystickHandler::BUTTON_NAMES = {
    {0x120, "trigger"},
    {0x121, "thumb"},
    {0x122, "thumb2"},
    {0x123, "top"},
